			...
			<table border="1" cellpadding="0" cellspacing="0" width="700">
				<tr>
					<td align="right">
						...
						<input id="btn_Search" type="button" value="<spring:message code="message.board.list.search.condition.btn"/>">
					</td>
				</tr>
			</table>			
		</form>
				...
				$.ajax({
					...
					success : function(obj) {
						...
						for(var i = 0; i < data.boardList.length; i++) {
							...
							htmlString += "		<td>";
							htmlString += "			<a href='getBoard.do?seq=" + data.boardList[i].seq + "'>" + decodeURIComponent(data.boardList[i].title) + "</a>";
							htmlString += "		</td>";
							htmlString += "		<td>" + decodeURIComponent(data.boardList[i].writer) + "</td>";
